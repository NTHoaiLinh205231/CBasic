...
dll_t dll_creat_list_song() {
  dll_t list = dll_creat_list();
  list->fn = dll_free_node_song;
  return list;
}*/
...
int main() {
  ...
  dll_push_back_song(list, "Chiếc lá thu phai", "/home/nva/musics/chiec-la-thu-phai.mp3");
  dll_push_back_song(list, "Mưa hồng", "/home/nva/musics/mua-hong.mp3");
  dll_push_back_song(list, "Nắng thủy tinh", "/home/nva/musics/nang-thuy-tinh.mp3");
